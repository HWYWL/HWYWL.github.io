---
title: Java线上服务CPU飙升问题定位
date: 2020-03-19 14:41:28
tags: 
 - Java
categories: 
 - Java
keywords: "Java"
description: Java线上服务CPU飙升问题定位。
---
## 安装（以下任意一种方式）
🐌 下载使用
====================================
...
这里一定要吹爆一个脚本**useful-scripts**，使用非常方便甚至可以让我们一键定位线上问题。
## Java相关脚本
- **show-busy-java-threads**
...
附上大佬的github脚本地址：https://github.com/oldratlee/useful-scripts